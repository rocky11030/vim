...
**PPS**: 一份tmux配置 [k-tmux](https://github.com/rocky11030/tmux)
...
```
cd /opt
git clone https://github.com/rocky11030/vim.git
```
...
3. 可以自己修改vimrc决定是否使用方向键进行上下左右移动，默认关闭，强迫自己用 hjkl，可以注解,已经注释掉
hjkl  上下左右
